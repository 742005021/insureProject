...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addViewControllers(ViewControllerRegistry registry) {
       ...
       // registry.addViewController("/toscore").setViewName("custop/score");
        ...
        registry.addViewController("/licai").setViewName("custop/licai");
        registry.addViewController("/demo").setViewName("custop/demo");
        registry.addRedirectViewController("/", "/index");
        //registry.addViewController("/tocoupon").setViewName("custop/coupon");
//        registry.addViewController("/toexit").setViewName("custop/exitpolicy");
    }
}
